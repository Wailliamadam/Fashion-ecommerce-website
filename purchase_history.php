...
if (isset($_GET['order_id'])) {
    ...
    try {
        ...
        // Process images for order items
        foreach ($order_items as &$item) {
            ...
            $item['image_path'] = empty($image_src) ? $default_product_image : $image_src;
        }
        ...
        <div class="order-card">
            ...
            <div class="order-body">
                ...
                <div class="customer-info">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p><strong>Name:</strong> <?php echo $order['first_name'] . ' ' . $order['last_name']; ?>
                            </p>
                ...
                <div class="order-item">
                    <img src="<?php echo $item['image_path']; ?>" alt="<?php echo htmlspecialchars($item['name']); ?>"
                        class="order-item-img" onerror="this.src='<?php echo $default_product_image; ?>'">
...
function toggleOrderDetails(element) {
    ...
    if (orderBody.classList.contains('show')) {
        const orderId = element.querySelector('h5').textContent.replace('Order #', '');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (orderId) {
        ...
        orderHeaders.forEach(header => {
            if (header.querySelector('h5').textContent.includes(orderId)) {
